...
@section('title', 'Absen Rayon ' . $rayon->rayon)
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-header-action">
                <a href="{{ route($link_role.'rayon.laporan', $rayon->id) }}?tanggal_pertama={{ request()->tanggal ??  date('d-m-Y') }}&tanggal_terakhir={{ request()->tanggal ?? date('d-m-Y') }}" class="btn btn-sm btn-primary">Lihat Laporan</a>
            </div>
        </div>
        <div class="card-body">
...
<form action="{{ route($link_role.'rayon.simpan_absen', $rayon->id) }}" method="POST">
    @csrf
                    ...
                    <li class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div class="text-small text-muted">{{ $siswa->nis }}
                                <div class="bullet"></div> {{ $siswa->rombel->rombel }}</div>
                        </div>
                    </li>
                @empty
