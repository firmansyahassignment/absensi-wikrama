...
<div class="section-header-breadcrumb">
    <div class="breadcrumb-item active"><a href="{{ route('guru.laporan.daftar_rombel') }}">Daftar Rombel</a></div>
    <div class="breadcrumb-item">Laporan Rombel RPL X-1</div>
</div>
    ...
    <form action="" method="GET">
        <div class="card-header">
            ...
            <div class="card-header-action dropdown">
                <button class="btn btn-md btn-primary"><i class="fas fa-exclamation-triangle"></i> Laporkan Kesalahan</button>
            </div>
        </div>
        <div class="card-body">
    ...
    <div class="card-header">
        ...
        <div class="card-header-action dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                ...
                <li><a href="{{ route('guru.absen.rombel', $rombel->id) }}?tanggal={{ request()->tanggal_pertama ?? date('d-m-Y') }}" class="dropdown-item">Edit</a></li>
    ...
    <div class="card-header">
        ...
        <div class="card-header-action dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                ...
                <li>
                    <a  class="dropdown-item" href="{{ route('guru.laporan.rombel_siswa_pdf_download', $rombel) }}?tanggal_pertama={{ format_local(request()->tanggal_pertama) }}&tanggal_terakhir={{ format_local(request()->tanggal_terakhir) }}">PDF</a>
                </li>
                <li>
                    <a  class="dropdown-item" href="{{ route('guru.laporan.rombel_siswa_xl_download', $rombel) }}?tanggal_pertama={{ format_local(request()->tanggal_pertama) }}&tanggal_terakhir={{ format_local(request()->tanggal_terakhir) }}">Excel</a>
                </li>
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <a href="{{ route('guru.absen.rombel', $item->rombel_id) }}?tanggal={{ format_local($item->tanggal_absen) }}" class="btn btn-sm btn-primary">edit</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
            ...
            <div class="modal-body">
                <table>
                    <tr>
                        ...
                        <td>:</td>
                        <td class="pl-2" id="modal_nama">Muhamad Firmansyah</td>
                    </tr>
                    <tr>
                        <td class="pr-3">NIS</td>
                        <td>:</td>
                        <td class="pl-2" id="modal_nis">11706176</td>
                    </tr>
                    <tr>
                        <td class="pr-3">Rayon</td>
                        <td>:</td>
                        <td class="pl-2" id="modal_rayon">Cicurug 5</td>
                    </tr>
                </table>
                <br>
                <div class="table-responsive">
